  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-middle">
        <p>
          SAVE OUR CULTURAL HERITAGE FOUNDATION is a COMPANY LIMITED BY SHARES NOT FOR PROFIT UNDER SECTION 8 OF THE COMPANIES ACT, 2013.<br />
          Regd. No. 366126 | Regd address: 206 Ashoka Apartments, Commercial Complex, Ranjeet Nagar, New Delhi – 110008, INDIA
        </p>
      </div>
